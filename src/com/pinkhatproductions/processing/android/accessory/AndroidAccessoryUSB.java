...
public class AndroidAccessoryUSB {
    private static final String TAG = "AndroidAccessory";
     ...
     * @param theParent
     */
    public AndroidAccessoryUSB(Context theParent) {
        myParent = theParent;
        welcome();
    ...
    // }
    public void connect() {
        UsbAccessory[] list = comm.getAccessories();
